...
#    plt.title("Age with respect to survivability")
    ...
    plt.scatter(df.Survived, df.Pclass, alpha=0.1)
    plt.title("Class with respect to survability")
#    plt.show()
...
#    plt.show()
    ...
    df.Survived[df.Pclass == 3].value_counts(normalize=True).plot(kind="bar", alpha=0.5)
    plt.title("Third Class Survival Rate")
    plt.subplot2grid((3,4), (0,2))
    df.Survived[df.Pclass == 2].value_counts(normalize=True).plot(kind="bar", alpha=0.5)
    plt.title("Second Class Survival Rate")
    plt.subplot2grid((3,4),(0,3))
    df.Survived[df.Pclass == 1].value_counts(normalize=True).plot(kind="bar", alpha=0.5)
  ...
  #  plt.show()
    ...
    plt.title("Class and Sex with respect to Survival")
    plt.legend(("1st", "2nd", "3rd", "Male", "Female"))
